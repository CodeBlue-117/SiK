		 ...
		 if(passCheck == true)
		 {
			...
			// if (dataReceived[0] == '1')
			 //{
				...
				else if(strlen((char*)dataReceived) > 3)
				{
					 APP_LOG(TS_ON, VLEVEL_L, "Received UART data greater than 3 bytes");
					 // Clear the dataReceived array
				}
			//}
