...
//    ret = my_write_reg(ctx->handle, LSM6DSO_CTRL9_XL, (uint8_t *)&ctrl9_xl, 1); // changed from lsm6dso_write_reg to my_write_reg and ctx to ctx->handle
//  }
//
//  if (ret == 0)
//  {
//    ret = my_read_reg(ctx->handle, LSM6DSO_I3C_BUS_AVB,
