...
#ifndef USE_IKS01A3_HYBRID_SENSOR_LSM6DSO_0
#define USE_IKS01A3_HYBRID_SENSOR_LSM6DSO_0  1
#endif

#if (USE_IKS01A3_HYBRID_SENSOR_LSM6DSO_0 == 1)
#include "lsm6dso.h"
#endif
...
#define IKS01A3_HYBRID_INSTANCES_NBR  (USE_IKS01A3_HYBRID_SENSOR_LSM6DSO_0)
